...
export async function generateMetadata({
  ...
  const meta = pageMeta.globalGrowthService[locale];
  const path = `/${locale}/business/globalgrowth/service`;
  return {
    title: meta.title,
    description: meta.description,
    alternates: {
      canonical: `${siteConfig.url}${path}`,
      languages: { ja: `${siteConfig.url}/ja/business/globalgrowth/service`, en: `${siteConfig.url}/en/business/globalgrowth/service` },
    },
    openGraph: {
      title: meta.title,
      description: meta.description,
