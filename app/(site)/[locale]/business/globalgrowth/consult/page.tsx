...
export async function generateMetadata({
  ...
  const meta = pageMeta.globalGrowthConsult[locale];
  const path = `/${locale}/business/globalgrowth/consult`;
  return {
    title: meta.title,
    description: meta.description,
    alternates: {
      canonical: `${siteConfig.url}${path}`,
      languages: { ja: `${siteConfig.url}/ja/business/globalgrowth/consult`, en: `${siteConfig.url}/en/business/globalgrowth/consult` },
    },
    openGraph: {
      title: meta.title,
      description: meta.description,
